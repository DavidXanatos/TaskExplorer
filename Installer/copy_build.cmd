...
IF %1 == x86 (
  ...
  set siPath=%~dp0..\ProcessHacker\KSystemInformer\bin\Release32
  call "C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\VC\Auxiliary\Build\vcvars32.bat"
  set qtPath=%~dp0..\..\Qt\%qt_version%\msvc2019
  set instPath=%~dp0\TaskExplorer_x86
)
IF %1 == x64 (
  set archPath=x64
  set phPath=%~dp0..\ProcessHacker\bin\Release64
  set siPath=%~dp0..\ProcessHacker\KSystemInformer\bin\Release64
  call "C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\VC\Auxiliary\Build\vcvars64.bat"
  set qtPath=%~dp0..\..\Qt\%qt_version%\msvc2019_64
  set instPath=%~dp0\TaskExplorer_x64
)
IF %1 == ARM64 (
  set archPath=ARM64
  set phPath=%~dp0..\ProcessHacker\bin\ReleaseARM64
  set siPath=%~dp0..\ProcessHacker\KSystemInformer\bin\ReleaseARM64
  ...
  set instPath=%~dp0\TaskExplorer_a64
...
copy /y %phPath%\ksidyn.bin %instPath%\
copy /y %phPath%\ksidyn.sig %instPath%\
