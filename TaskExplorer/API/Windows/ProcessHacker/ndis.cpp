    ...
    )
{
    ...
    objectIdBuffer = (PNDIS_OID)PhAllocateZero(objectIdBufferLength);
    ...
    )
{
    ...
    if (!GetInterfaceDescriptionFromGuid_I)
    {
        ...
        {
            GetInterfaceDescriptionFromGuid_I = (_GetInterfaceDescriptionFromGuid)PhGetProcedureAddress(IphlpHandle, "NhGetInterfaceDescriptionFromGuid", 0);
        }
    }
