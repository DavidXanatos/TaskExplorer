 ...
 * @returns an int
 */
JSON_EXPORT int json_object_array_length(const struct json_object *obj);
...
*/
JSON_EXPORT void json_object_array_sort(struct json_object *jso, int(__cdecl* sort_fn)(const void *, const void *));
