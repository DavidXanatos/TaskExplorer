...
#pragma alloc_text(NONPAGE, log_buffer_init)
#pragma alloc_text(NONPAGE, log_buffer_free)
#pragma alloc_text(NONPAGE, log_buffer_push_entry)
#pragma alloc_text(NONPAGE, log_buffer_pop_entry)
#pragma alloc_text(NONPAGE, log_buffer_byte_at)
#pragma alloc_text(NONPAGE, log_buffer_push_bytes)
#pragma alloc_text(NONPAGE, log_buffer_get_bytes)
#pragma alloc_text(NONPAGE, log_buffer_get_size)
#pragma alloc_text(NONPAGE, log_buffer_get_seq_num)
#pragma alloc_text(NONPAGE, log_buffer_get_next)

LOG_BUFFER* log_buffer_init(SIZE_T buffer_size)
{
	//LOG_BUFFER* ptr_buffer = (LOG_BUFFER*)malloc(sizeof(LOG_BUFFER) + buffer_size);
	LOG_BUFFER* ptr_buffer = (LOG_BUFFER*)ExAllocatePoolWithTag(NonPagedPool, buffer_size, 'lhpK');
	if (ptr_buffer != NULL)
	{
...
{
	//free(ptr_buffer);
	ExFreePoolWithTag(ptr_buffer, 'lhpK');
}
