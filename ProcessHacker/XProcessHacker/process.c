...
// PPL Support
#pragma alloc_text(PAGE, KpiSetProcessProtection)
//
#endif
...
// PPL Support
extern ULONG PsProtectionOffset;
extern ULONG SignatureLevelOffset;
extern ULONG SectionSignatureLevelOffset;
...
NTSTATUS KpiSetProcessProtection(
...
)
{
    ...
    status = SetProcessesProtectionFlag(PsProtectionOffset, SignatureLevelOffset, SectionSignatureLevelOffset, UniqueProcessId, Flag);
