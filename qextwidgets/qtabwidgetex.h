...
#ifndef QTABWIDGET_EX_H
#define QTABWIDGET_EX_H
...
class QTabBarEx;
class QTabWidgetExPrivate;
class QStyleOptionTabWidgetFrame;

class QEXTWIDGETS_EXPORT QTabWidgetEx : public QWidget
{
    Q_OBJECT
	...
	Q_PROPERTY(bool multiRow READ isMultiRow WRITE setMultiRow)
...
private:
    Q_DECLARE_PRIVATE(QTabWidgetEx)
    Q_DISABLE_COPY(QTabWidgetEx)
