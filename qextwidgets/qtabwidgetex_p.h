...
#ifndef QTABWIDGET_EX_P_H
#define QTABWIDGET_EX_P_H
...
class QTabWidgetExPrivate : public QWidgetPrivate
{
    Q_DECLARE_PUBLIC(QTabWidgetEx)
...
public:
    ...
    {
        // see QTabBarExPrivate::autoHideTabs()
    ...
    QRect panelRect;
    bool dirty;
    QTabWidgetEx::TabPosition pos;
    QTabWidgetEx::TabShape shape;
