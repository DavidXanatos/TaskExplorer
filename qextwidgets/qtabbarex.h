...
class QIcon;
class QTabBarExPrivate;
class QStyleOptionTab;

class QEXTWIDGETS_EXPORT QTabBarEx: public QWidget
{
    Q_OBJECT
...
public:
    explicit QTabBarEx(QWidget *parent = nullptr);
    ~QTabBarEx();
...
#endif
private:
    Q_DISABLE_COPY(QTabBarEx)
    Q_DECLARE_PRIVATE(QTabBarEx)
